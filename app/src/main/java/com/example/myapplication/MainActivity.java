        ...
        addEditLauncher = registerForActivityResult(
                ...
                result -> {
                    if (result.getResultCode() == RESULT_OK && result.getData() != null) {
                        ...
                        if (AddEditActivity.MODE_ADD.equals(mode)) ajouterLivreDansRoom(livre);
                        else if (AddEditActivity.MODE_EDIT.equals(mode)) modifierLivreDansRoom(livre);
                    }
                }
        );
    }
...
private void afficherOptionsLivre(Livre livre) {
    ...
    new AlertDialog.Builder(this)
            ...
            .setItems(options, (dialog, which) -> {
                ...
                else if (which == 1) confirmerSuppression(livre);
            }).show();
}
...
private void confirmerSuppression(Livre livre) {
    new AlertDialog.Builder(this)
            ...
            .setPositiveButton("Supprimer", (d, w) -> supprimerLivreDansRoom(livre))
